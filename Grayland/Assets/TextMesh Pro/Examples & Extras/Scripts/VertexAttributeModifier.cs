...
public class VertexAttributeModifier : MonoBehaviour
{
    ...
    void Awake()
    {
        dialogueWrite = gameObject.GetComponent<DialogueWrite>();
...
//    [Button("Stop")]
    ...
    public void PlayAnimation(DialogueSet dialogueSet)
    {
        Stop();
        ...
        VertexCurve = dialogueSet.VertexCurve;
        AngleMultiplier = dialogueSet.AngleMultiplier;
        SpeedMultiplier = dialogueSet.SpeedMultiplier;
        CurveScale = dialogueSet.CurveScale;

        DangleRefresh = dialogueSet.DangleRefresh;
        DanglingRange = dialogueSet.DanglingRange;
        DanglingSpeed = dialogueSet.DanglingSpeed;
